...
export default function TotalTahunDataUserPage() {
            ...
            <Card className="px-10 py-10">
                <div className="container mx-auto py-10">
                    ...
                    {sortedYears.map((year, index) => (
                        <div key={year} style={{ display: index + 1 === currentPage ? 'block' : 'none' }}>
                            ...
                            <Table className="w-full border-collapse border border-gray-300 my-4 shadow-lg">
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell className="border border-gray-300 font-semibold text-right">{formatIDR(groupedByYear[year].reduce((acc, curr) => acc + curr.total_release, 0))}</TableCell>
                                        <TableCell className="border border-gray-300 font-semibold text-right">{formatIDR(groupedByYear[year].reduce((acc, curr) => acc + curr.total_realisasi, 0))}</TableCell>
                                        <TableCell className="border border-gray-300 font-semibold text-right">{formatIDR(groupedByYear[year].reduce((acc, curr) => acc + curr.total_saldo, 0))}</TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell className="border border-gray-300 font-semibold text-right">
                                            {((groupedByYear[year].reduce((acc, curr) => acc + curr.total_realisasi, 0) / groupedByYear[year].reduce((acc, curr) => acc + curr.total_release, 0)) * 100).toFixed(2)}%
                                        </TableCell>
