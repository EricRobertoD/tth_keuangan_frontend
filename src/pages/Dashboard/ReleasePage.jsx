...
export default function ReleasePage() {
    ...
    const [jumlahRelease, setJumlahRelease] = useState();
    ...
    const storeRelease = () => {
        Swal.fire({
            ...
            text: "Apakah anda ingin menambahkan release?",
            icon: "info",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
            confirmButtonText: "Ya, tambahkan release!",
        }).then((result) => {
            if (result.isConfirmed) {
                const dataRelease = {
                    id_kategori: [...selectedKategoriId][0],
                    id_divisi: [...selectedDivisiId][0],
                    input_value: jumlahRelease,
                    bulan: selectedMonth,
                    tahun: selectedYear,
                    uraian: uraian,
                };
                ...
                fetch(`${BASE_URL}/api/release`, {
                    ...
                    .then((responseData) => {
                        if (responseData.status === 'success') {
                            ...
                            Swal.fire({
                                icon: "success",
                                title: "Berhasil Melakukan Release",
                                text: "Anda berhasil melakukan release",
                            });
                        } else {
                        ...
                        <div className="flex-1">
                            <CardHeader className="flex gap-3">
                                <div className="flex flex-col">
                                    <p className="text-xl font-bold">Release</p>
                                    <p className="text-small text-default-500">Penambahan jumlah saldo</p>
                                </div>
                            </CardHeader>
                            <Divider />
                        </div>
                        ...
                        <div className="flex-1">
                            ...
                            <div className="col-span-1 m-5">
                                <Input
                                    ...
                                    variant="bordered"
                                    value={jumlahRelease ? Number(jumlahRelease).toLocaleString('id-ID') : ''}
                                    onChange={(e) => setJumlahRelease(e.target.value.replace(/[^\d]/g, ''))}
                                />
                            </div>
                            <div className="col-span-1 m-5">
                                <Input
                            ...
                            <div>
                                <Button className="col-span-1 m-5 bg-red-500 text-white" onPress={storeRelease}>
                                    Save
                                </Button>
                            </div>
                        </div>
